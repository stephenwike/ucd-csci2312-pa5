...
//
//TODO: sstream added to original file  Also maybe string too
#include <iostream>
#include <string>
#include <sstream>
#include <cassert>
    ...
    for (int run = 0; run < numRuns; run ++) {
...

        {
            ...
            if (m.size() != 1) { // parse problem
                ...
                std::istringstream(m[0]) >> id;//id = atoi(m[0]);  //TODO - STOI is not working...
                pass = true;
            }
...
//        if (! pass) std::cout << ss.str() << std::endl;
    ...
    for (int i = 0; i < 10; i ++) {
        ...
        pass = (ss0.str() == "4 4 4 4 5 6 4 1 6 "); //std::cout << ss0.str();   //TODO: get rid of std::cout
